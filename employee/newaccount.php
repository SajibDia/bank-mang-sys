            ...
            <div class="container-fluid">
                ...
                <form id="form" method="post" enctype="multipart/form-data">
                    ...
                    <div class="box-body">
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                <p for="exampleInputEmail1" style="margin-bottom: 1px; margin-top: 8px;">NID Number</p>
                                <input type="number" name="cnic" class="form-control" placeholder="Enter Your NID number" required>
                            </div>
                            <div class="col-lg-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                ...
                                <input type="number" class="form-control" id="blnc" name="balance" min="20" placeholder="Minimum £20" required>
                            </div>
                            <div class="col-lg-4">
            ...
            <div class="row clearfix" id="not">
                <div class="footer-basic" id="bot">
                    <footer>
                        ...
                        <p class="copyright" style="margin-top: 0px;">Investo UK Plc © copyright 2024</p>
                    </footer>
                </div>
            </div>
        </section>
