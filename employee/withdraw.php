...
<nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="../dashboard.php" style="font-size: 18px;">INVESTO UK Plc</a>
            </div>
       ...
       <div class="container-fluid">
            ...
            <div class="row clearfix">
              ...
              <hr style="height:1px;border-width:0; width: 100%; margin-bottom:  -5px; margin-top: 20px; color:red;background-color:gray;">
                    <br>
                   <p style="text-align: left; font-weight: bold;">Enter Account Number</p>
                <div class="box-body">
                  ...
                  if(mysqli_num_rows($nm)>0){
                    ...
                    <div class="row">
                        ...
                        <div  class="col-sm-6">
                            ...
                            <input type="text" class="form-control" name="blnc" value="<?php echo $row['balance'];?>"  readonly>
                        </div>
                    </div>
                    <hr style="height:1px;border-width:0; width: 100%; margin-bottom:  -5px; margin-top: 20px; color:red;background-color:gray;">
                    <br>
                   ...
                   <div class="row">
                        <div  class="col-sm-5">
                            ...
                            <input type="number" class="form-control" name="amount" id="am" min="10" placeholder="Enter withdraw amount" required>
                        </div>
                        <div  class="col-sm-2">
                        <input type="submit"  class="btn btn-primary form-control" style="margin-top: 28px; font-size: 17px; width: 120px; border-radius: 5px;" name="transfer" id="trans" value="Withdraw" onclick="var vl = document.getElementById('am').value; var e=this;var s=document.getElementById('sbtn');setTimeout(function(){if(vl>=10){e.disabled=true;s.disabled=true;}},0); return true;">
                       </div>
                    </div>
                    </form>
                    <?php
