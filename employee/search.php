    ...
    <section class="content" id="top">
       <div class="container-fluid">
            ...
            <br>
                <div class="row">
                <div class="col-sm-4">
                    <input type="text" id="myInput" class="cs form-control" onkeyup="myFunction()" placeholder="Search with name, NID, title, account" title="Type in a name">
                </div>
                <div  class="col-sm-2">
                    ...
                    <table class="table" id="myTable">
                      <thead>
                        <tr style="text-align: center;" class="tb">
                          ...
                          <th style="text-align: center; width: 15%;">NID Number</th>
