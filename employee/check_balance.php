       ...
       <div class="container-fluid">
            ...
            <div class="row clearfix">
              ...
              <hr style="height:1px;border-width:0; width: 100%; margin-bottom:  -5px; margin-top: 20px; color:red;background-color:gray;">
                    <br>
                   <p style="text-align: left; font-weight: bold;">Enter Account Number to Check Balance</p>
                <div class="box-body">
                  ...
                  ?>
                    ...
                    <div class="row">
                        ...
                        <div  class="col-sm-6">
                            ...
                            <input type="text" class="form-control" name="reciever2" value="<?php echo $row['balance'];?>"  readonly>
                        </div>
                    </div>
                    <hr style="height:1px;border-width:0; width: 100%; margin-bottom:  -5px; margin-top: 20px; color:red;background-color:gray;">
                    <br>
