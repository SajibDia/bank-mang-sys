       ...
       <div class="container-fluid">
            ...
            <div class="col-sm-4">
              ...
              if (isset($number)) {
               ...
               ?>
              <input type="text" name="pt" value="<?php echo "Total Amount = £ ". $number ?>" readonly class="form-control">
            </div>
            </div>
            <br>
                    ...
                    <tbody id="body">
                      ...
                      ?>
                       <tr>
                          ...
                          <td style="text-align: center;padding-top: 25px;"><?php echo "£ ".$row['amount'];?></td>
                      <?php
                         }
                         }else{
                        ?>
