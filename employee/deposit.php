                  ...
                  if(mysqli_num_rows($nm)>0){
                   ...
                   <div class="row">
                        <div  class="col-sm-5">
                            ...
                            <input type="number" class="form-control" name="amount" id="am" placeholder="Enter deposit amount" required>
                        </div>
                        <div  class="col-sm-2">
                        <input type="submit"  class="btn btn-primary form-control" style="margin-top: 28px; font-size: 17px; width: 120px; border-radius: 5px;" name="transfer" id="trans" value="Deposit" onclick="var vl = document.getElementById('am').value; var e=this;var s=document.getElementById('sbtn');setTimeout(function(){if(vl>=0){e.disabled=true;s.disabled=true;}},0); return true;">
                       </div>
                    </div>
                    </form>
                    <?php
