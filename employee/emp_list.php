    ...
    <section class="content" id="top">
       <div class="container-fluid">
            ...
            <br>
                <div class="row">
                <div class="col-sm-4">
                    <input type="text" id="myInput" class="cs form-control" onkeyup="myFunction()" placeholder="Search from table with id, name and NID" title="Type in a name">
                </div>
                <?php 
                    ...
                    <table class="table" id="myTable">
                      <thead>
                        <tr style="text-align: center;" class="tb">
                          ...
                          <th style="text-align: center; width: 14%;">NID Number</th>
